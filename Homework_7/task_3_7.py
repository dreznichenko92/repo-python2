...
class MyCell:
    ...
    def __add__(self, other):
        some_number = self.some_number + other.some_number
        return MyCell(some_number)

    def __str__(self):
        return f'{self.some_number}'

    def __sub__(self, other):
        if self.some_number - other.some_number > 0:
            some_number = self.some_number - other.some_number
            return MyCell(some_number)
        else:
    ...
    def __truediv__(self, other):
        some_number = round(self.some_number // other.some_number)
        return MyCell(some_number)

    def make_order(self, params):
        x = ''
        for i in range(int(self.some_number // params)):
            x += "*" * params + '\n'
        x += "*" * (self.some_number % params) + '\n'
        return x
